        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            <div className='md:w-1/2 mb-8 ml-2 md:mb-0'>
              ...
              <div className='flex space-x-4'>
                <a href="https://www.facebook.com/aadesh.pawar.798" className='text-foreground/60 hover:text-foreground/80'>
                <img src={facebook} alt="" className='h-6 w-6'/></a>
                <a href="https://www.instagram.com/_aadesh_pawar?igsh=OW1wdWx5dmloaTd1&utm_source=qr" className='text-foreground/60 hover:text-foreground/80'>
                <img src={instagram} alt="" className='h-6 w-6'/></a>
                <a href="https://www.linkedin.com/in/aadesh-pawar2000/" className='text-foreground/60 hover:text-foreground/80'>
